...
const LABELS = {
  ...
  en: {
    header: "New order — Chaikhana Raykhan",
    name: "Name",
    phone: "Phone",
    method: "Order type",
    delivery: "Delivery",
  ...
  tg: {
    header: "Фармоиши нав — Чойхонаи Райҳон",
    name: "Ном",
    phone: "Телефон",
    method: "Усули гирифтан",
    delivery: "Расонидан",
    pickup: "Гирифтан аз ҷо",
    address: "Суроға",
    comment: "Шарҳ",
    items: "Таркиби фармоиш",
    subtotal: "Маблағ",
 ...
 */
export function buildWhatsAppOrderUrl({ lang, customer, items, subtotal, deliveryFee, total }) {
