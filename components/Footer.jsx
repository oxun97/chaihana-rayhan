...
export default function Footer() {
  ...
  return (
    <>
      <div className="ornament-divider bg-cream" />

      <section className="pattern-lattice-lg relative overflow-hidden bg-gradient-to-br from-ink via-ink to-teal-dark px-6 py-16 text-center text-white">
      ...
      <footer className="border-t border-gold/10 bg-cream px-4 py-8 text-center text-[0.76rem] text-ink-soft">
        <p>
